...
//      int teamCode_ = orgDao.getTeamCode(member.getEmp_dept());
   ...
   /*개인정보수정*/
   @Override
   public int infoUpdate(MemberProfile memberProfile) { //서비스 //MemberMapper
      memberProfile.setEmp_pw(pwencoder.encode(memberProfile.getEmp_pw()));
      return memberDao.infoUpdate(memberProfile);
