...
public class EmpController {
	...
	@PostMapping("byeSuccess")
	public void byeSuccess(String emp_id, HttpServletResponse response) throws IOException {
		commuteService.byeSuccess(emp_id);
		response.sendRedirect("/emp/main");
	}
	...
	@GetMapping("byList")
	public String allByList() {
		return "emp.timeRecord.byList";
	}
}
